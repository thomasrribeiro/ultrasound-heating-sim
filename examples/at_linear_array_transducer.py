...
Original file is located at
    https://colab.research.google.com/github/waltsims/k-wave-python/blob/master/examples/at_linear_array_transducer/at_linear_array_transducer.ipynb
"""
...
time_delays = (
    -(np.sqrt((ids * element_pitch) ** 2 + source_focus**2) - source_focus) / c0
)
...
for ind in range(element_num):
    x_pos = (
        0 - (element_num * element_pitch / 2 - element_pitch / 2) + ind * element_pitch
    )
    karray.add_rect_element(
        [x_pos, 0, kgrid.z_vec[0][0]], element_width, element_length, rotation
    )
